...
# Install
    ...
    $ go get github.com/magartifex/goose/cmd/goose

This will install the `goose` binary to your `$GOPATH/bin` directory.

You can also build goose into your own applications by importing `github.com/magartifex/goose/lib/goose`. Documentation is available at [godoc.org](http://godoc.org/goose/lib/goose).
...
import _ "github.com/magartifex/goose/cmd/goose"
```
