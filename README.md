...
# Install
    ...
    $ go get goose/cmd/goose

This will install the `goose` binary to your `$GOPATH/bin` directory.

You can also build goose into your own applications by importing `goose/lib/goose`. Documentation is available at [godoc.org](http://godoc.org/goose/lib/goose).
